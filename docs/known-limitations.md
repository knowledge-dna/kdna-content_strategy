...
This document declares known limitations of the kdna-content_strategy domain judgment package.
This is required by the [KDNA Governance Policy](https://github.com/aikdna/KDNA/blob/main/GOVERNANCE.md).

## Scope Limitations
- This domain's judgment is bounded to its declared field: content_strategy.
